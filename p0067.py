...
Find the maximum total from top to bottom in triangle.txt https://goo.gl/US8ZuB (right click and
...
from p0018 import triangle_to_mat, sume_at_row

if __name__ == "__main__":
    data = triangle_to_mat('data0067.txt')
